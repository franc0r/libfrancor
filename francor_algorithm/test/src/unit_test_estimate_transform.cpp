...
{
  for (Angle angle = Angle::createFromDegree(-180.0); angle < Angle::createFromDegree(180.0); angle += Angle::createFromDegree(1.0))
  {
    const Transform2d transform( { angle }, { 1.0, 2.0 } );
